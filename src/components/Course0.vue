<template>
  <div class="course-details">
    ...
    <main>
      ...
      <p class="content">avec si peu de mots, il est bien sûr essentiel de les rentabiliser : de nombreux mots sont des noms, mais peuvent aussi être verbe, adjectif, auxiliaire...</p>
      ...
      <h2>en résumé</h2>
      <p class="content">le toki pona, bien que très minimaliste, peut être particulièrement expressif. sa grande simplicité lui permet d'être appris par à peu près n'importe qui, quelle que soit sa culture, son niveau d'instruction, le temps dont l'on dispose : c'est l'anti-Babel. c'est une passerelle qui permet de franchir la barrière de la langue.</p>
      <p class="content">je persiste à penser qu'en favorisant la communication entre les différents peuples ils se connaitraient mieux, se comprendraient mieux, s'apprécieraient mutuellement à leur juste valeur et que ça calmerait les intentions guerrières : on a rarement envie d'aller taper sur quelqu'un que l'on connaît et que l'on sait apprécier.</p>
    </main>
  </div>
</template>
