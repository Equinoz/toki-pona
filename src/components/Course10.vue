<template>
  <div class="course-details">
    ...
    <main>
      <h2>vocabulaire</h2>
      <p class="content">
        <span class="new-word">pilin</span> coeur (physique et psychologique), sentir, penser, qui ressent<br />
        <span class="new-word">sijelo</span> corps, état physique, torse<br />
        <span class="new-word">monsi</span> fesses, dos, derrière, arrière<br />
        <span class="new-word">insa</span> centre, contenu, intérieur, estomac, viscères, dedans, entre<br />
        <span class="new-word">poka</span> côté, proximité, hanche, proche, à côté, auprès, en compagnie de<br />
        <span class="new-word">noka</span> partie inférieure, organe de locomotion, pied, jambe, bas, dessous<br />
        <span class="new-word">selo</span> forme, couche extérieure, écorce, pelure, coquille, limite, surface externe, peau<br />
        <span class="new-word">ko</span> argile, pâte, poudre, substance collante, semi-solide
      </p>
      <h3>particule</h3>
      <p class="content"><span class="new-word">pi</span> particule "de"<br /></p>
