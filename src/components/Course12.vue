<template>
  <div class="course-details">
    ...
    <main>
      <h2>vocabulaire</h2>
      <p class="content">
        <span class="linja-pona new-glyph">lape</span><span class="new-word">lape</span> repos, dormir, dormant, se reposant<br />
        <span class="linja-pona new-glyph">unpa</span><span class="new-word">unpa</span> sexe, sexuel, avoir des rapports sexuels avec
      </p>
      <h3>auxiliaires</h3>
      <p class="content">
        <span class="linja-pona new-glyph">kama</span><span class="new-word">kama</span> futur, qui arrive, qui vient, venir, advenir, devenir, arriver à, réussir à, être la cause de, venu<br />
        <span class="linja-pona new-glyph">wile</span><span class="new-word">wile</span> désir, devoir, vouloir, avoir besoin de<br />
        <span class="linja-pona new-glyph">awen</span><span class="new-word">awen</span> attendre, rester, demeurer, continuer à, resté, protégé, gardé, conservé, qui attend, qui persiste<br />
        <span class="linja-pona new-glyph">sona</span><span class="new-word">sona</span> connaissance, sagesse, savoir, connaître<br />
        <span class="linja-pona new-glyph">ken</span><span class="new-word">ken</span> possibilité, pouvoir, possible, être capable de
      </p>
