<template>
  <div class="course-details">
    ...
    <main>
      <h2>vocabulaire</h2>
      <p class="content">
        <span class="linja-pona new-glyph">pana</span><span class="new-word">pana</span> donner, envoyer, mettre, fournir, émettre, lâcher, libérer<br />
        <span class="linja-pona new-glyph">musi</span><span class="new-word">musi</span> jeu, divertissement, amuser, jouer, artistique, frivole, divertissant, amusant<br />
        <span class="linja-pona new-glyph">open</span><span class="new-word">open</span> commencer, ouvrir, allumer, démarrer<br />
        <span class="linja-pona new-glyph">pini</span><span class="new-word">pini</span> fin, finir, arrêter, éteindre, fini, passé, terminé<br />
        <span class="linja-pona new-glyph">anpa</span><span class="new-word">anpa</span> sol, bas, baisser, vaincre, incliné vers le bas, humble, qui dépend, profond, prosterné<br />
        <span class="linja-pona new-glyph">sewi</span><span class="new-word">sewi</span> haut, ciel, toit, chose élevée, partie supérieure, divin, sacré, surnaturel, supérieur, inspirant le respect/crainte, dessus<br />
        <span class="linja-pona new-glyph">tenpo</span><span class="new-word">tenpo</span> temps, durée, moment, occasion, période, situation
      </p>
