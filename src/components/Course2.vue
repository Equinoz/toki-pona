<template>
  <div class="course-details">
    ...
    <main>
      ...
      <ul>
        <li>le contexte</li>
        <li>l'ajout d'un ou plusieurs mots au premier mot pour mieux le définir</li>
      </ul>
      ...
      <p>en utilisant le mot "moku", comment vais-je faire la différence entre du miel et une bière impériale stout à 9°* ? je vais donc préciser : "moku jelo" pour "aliment jaune" si ce qui, selon moi, caractérise le mieux le miel est sa couleur, ou "moku suwi" pour "aliment sucré" si je préfère faire référence à son goût doux et sucré.</p>
      ...
      <p class="content">(en réalité il existe quelques expressions usuelles pour souhaiter "bonjour" ou "au revoir", expressions que nous verrons plus tard)</p>
