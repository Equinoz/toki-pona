...
export const exercises = [
  ...
  { id: 43, type: "tpToLang" as TypeExercise, idsCourse: [4, 5, 6], question: "mama ni li ike", answer: "ce parent est malveillant" },
  ...
  { id: 71, type: "langToTp" as TypeExercise, idsCourse: [9], question: "cette femme creuse un trou", answer: "meli ni li pali e lupa" },
  ...
  { id: 90, type: "tpToLang" as TypeExercise, idsCourse: [12], question: "mama mi li tawa telo suli", answer: "mes parents vont à la mer" },
  { id: 91, type: "tpToLang" as TypeExercise, idsCourse: [12], question: "mi pali mute tan ni", answer: "je travaille beaucoup à cause de ça" },
  { id: 92, type: "tpToLang" as TypeExercise, idsCourse: [12], question: "kala li jaki tawa mi", answer: "les fruits de mer me dégoutent" },
  { id: 93, type: "langToTp" as TypeExercise, idsCourse: [12], question: "les gens travaillent pour les mauvaises raisons", answer: "ijo li pali tan ike" },
  { id: 94, type: "langToTp" as TypeExercise, idsCourse: [12], question: "j'aime le toki pona", answer: "toki pona li pona tawa mi" },
  { id: 95, type: "langToTp" as TypeExercise, idsCourse: [12], question: "cette bouteille est parmi les ordures", answer: "poki ni li lon jaki" },
  { id: 96, type: "tpToLang" as TypeExercise, idsCourse: [11, 12], question: "ona li kama tan ma sina", answer: "il arrive de ton pays" },
  { id: 97, type: "tpToLang" as TypeExercise, idsCourse: [11, 12], question: "mi wile sona e tan", answer: "je veux connaître les raisons" },
  { id: 98, type: "tpToLang" as TypeExercise, idsCourse: [11, 12], question: "lipu wile li lon tomo sina", answer: "les papiers nécessaires sont dans ta chambre" },
  { id: 99, type: "langToTp" as TypeExercise, idsCourse: [11, 12], question: "les oiseaux peuvent apprendre beaucoup de choses avec les livres", answer: "waso li ken kama sona e ijo mute kepeken lipu" },
  { id: 100, type: "langToTp" as TypeExercise, idsCourse: [11, 12], question: "je veux aller chez lui avec ma voiture", answer: "mi wile tawa tomo ona kepeken tomo tawa mi" },
  { id: 101, type: "langToTp" as TypeExercise, idsCourse: [11, 12], question: "ils se disputent", answer: "ona li utala toki" },
  { id: 102, type: "tpToLang" as TypeExercise, idsCourse: [13], question: "ni li jan sewi", answer: "c'est une personne sage" },
  { id: 103, type: "tpToLang" as TypeExercise, idsCourse: [13], question: "mi alasa monsi kasi suli mute", answer: "je chasse derrière la forêt" },
  { id: 104, type: "tpToLang" as TypeExercise, idsCourse: [13], question: "ona li anpa e jan utala", answer: "elle a vaincu le guerrier" },
  { id: 105, type: "langToTp" as TypeExercise, idsCourse: [13], question: "elle donne de la nourriture", answer: "ona pana moku" },
  { id: 106, type: "langToTp" as TypeExercise, idsCourse: [13], question: "ton visage est divin", answer: "sinpin sina li sewi" },
  { id: 107, type: "langToTp" as TypeExercise, idsCourse: [13], question: "son chien regarde la pluie", answer: "soweli ona li lukin e telo sewi" },
  { id: 108, type: "tpToLang" as TypeExercise, idsCourse: [11, 13], question: "mi wile ala pali lon tenpo lon", answer: "je ne veux pas travailler maintenant" },
  { id: 109, type: "tpToLang" as TypeExercise, idsCourse: [11, 13], question: "soweli wawa li kama anpa", answer: "le puissant animal a été vaincu" },
  { id: 110, type: "tpToLang" as TypeExercise, idsCourse: [11, 13], question: "mi lape lili anpa kasi suli", answer: "je fais la sieste sous l'arbre" },
  { id: 111, type: "langToTp" as TypeExercise, idsCourse: [11, 13], question: "de mauvaises choses ont eu lieu ici par le passé", answer: "ike li kama lon ni lon tenpo pini" },
  { id: 112, type: "langToTp" as TypeExercise, idsCourse: [11, 13], question: "ils peuvent attendre le début de la partie", answer: "ona mute li ken awen e open musi" },
  { id: 113, type: "langToTp" as TypeExercise, idsCourse: [11, 13], question: "tu as appris la menuiserie par le passé", answer: "sina kama sona e pali pi ijo kasi li lon tenpo pini" },
  { id: 114, type: "tpToLang" as TypeExercise, idsCourse: [12, 13], question: "waso li tawa sewi lon tenpo ale", answer: "les oiseaux volent tout le temps" },
  { id: 115, type: "tpToLang" as TypeExercise, idsCourse: [12, 13], question: "mi wawa mute lon tenpo pini", answer: "j'étais très confiante par le passé" },
  { id: 116, type: "tpToLang" as TypeExercise, idsCourse: [12, 13], question: "lipu ni li lon tenpo ale", answer: "ce document existera toujours" },
  { id: 117, type: "langToTp" as TypeExercise, idsCourse: [12, 13], question: "il y a quelque chose sous ce classeur", answer: "ijo li lon anpa pi lipu ni" },
  { id: 118, type: "langToTp" as TypeExercise, idsCourse: [12, 13], question: "l'association débat dans le forum", answer: "kulupu li toki lon tomo toki" },
  { id: 119, type: "langToTp" as TypeExercise, idsCourse: [12, 13], question: "il est au-dessus de moi", answer: "ona li lon sewi mi" },
  { id: 120, type: "tpToLang" as TypeExercise, idsCourse: [11, 12, 13], question: "mi moku tan ni: mi wile moku", answer: "je mange parce que j'ai faim" },
  { id: 121, type: "tpToLang" as TypeExercise, idsCourse: [11, 12, 13], question: "mi wile lon poka sina tan ni: mi olin e sina", answer: "je veux être à tes côtés car je t'aime" },
  { id: 122, type: "tpToLang" as TypeExercise, idsCourse: [11, 12, 13], question: "mi ken tawa sina lon tenpo poka", answer: "je peux te rejoindre bientôt" },
  { id: 123, type: "langToTp" as TypeExercise, idsCourse: [11, 12, 13], question: "l'insecte est sous le panier", answer: "pipi li lon anpa poki" },
  { id: 124, type: "langToTp" as TypeExercise, idsCourse: [11, 12, 13], question: "je veux combattre l'ennemi avec des cailloux", answer: "mi wile utala e jan ike kepeken kiwen" },
  { id: 125, type: "langToTp" as TypeExercise, idsCourse: [11, 12, 13], question: "je te rejoins dans le futur", answer: "mi tawa sina lon tenpo kama" },
]
